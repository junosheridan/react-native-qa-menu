...
export class JSONNestedNode extends React.PureComponent {
  ...
  render() {
    ...
    const itemType = <Text {...styling('nestedNodeItemType', expanded)}>{nodeTypeIndicator}</Text>
    ...
    return hideRoot ? (
      <View {...styling('rootNode', ...stylingArgs)}>
        <View {...styling('rootNodeChildren', ...stylingArgs)}>{renderedChildren}</View>
      </View>
    ) : (
      <View {...styling('nestedNode', ...stylingArgs)}>
        <View style={{ flexDirection: 'row' }}>
          ...
          <Text {...styling('nestedNodeItemString', ...stylingArgs)} onPress={onPressItemString}>
            {renderedItemString}
          </Text>
        </View>
        {expanded ? (
          <View {...styling('nestedNodeChildren', ...stylingArgs)}>{renderedChildren}</View>
        ) : null}
      </View>
    )
  }
